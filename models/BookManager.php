...
class BookManager extends AbstractEntityManager {
    ...
    public function getBookById(int $id) : ?Book
    {
     ...
     /**
     * Récupère un livre disponible par son titre.
     * @param string $title : le titre du livre.
     * @return Book|null : un objet Book ou null si le livre n'existe pas.
     */
    public function getAvailableBookByTitle(string $title) : ?Book
    {
        $sql = "SELECT * FROM book WHERE title LIKE :title AND available = 1";
